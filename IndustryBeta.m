function TotalLeveredBeta = IndustryBeta (Industry)
  
  if(Industry == "Advertising")
     TotalLeveredBeta = 8.22
  elseif(Industry == "Aerospace/Defense")
     TotalLeveredBeta = 4.09
  elseif(Industry == "Air Transport")
  ...
  elseif(Industry == "Beverage (Alcoholic)")
     TotalLeveredBeta = 6.45
  ...
  elseif(Industry == "Chemical (Diversified)")
     TotalLeveredBeta = 3.89
  elseif(Industry == "Chemical (Specialty)")
     TotalLeveredBeta = 3.74
  ...
  elseif(Industry == "Diversified")
     TotalLeveredBeta = 3.9
  ...
  elseif(Industry == "Insurance (Life)")
     TotalLeveredBeta = 2.29
  elseif(Industry == "Insurance (Prop/Cas.)")
     TotalLeveredBeta = 1.83
  ...
  elseif(Industry == "Oil/Gas (Integrated)")
     TotalLeveredBeta = 2.35
  elseif(Industry == "Oil/Gas (Production and Exploration)")
     TotalLeveredBeta = 6.86
  elseif(Industry == "Oil/Gas Distribution")
     TotalLeveredBeta = 2.86
  elseif(Industry == "Oilfield Svcs/Equip.")
     TotalLeveredBeta = 5.8
  ...
  elseif(Industry == "Reinsurance")
     TotalLeveredBeta = 1.25
  ...
  elseif(Industry == "Semiconductor Equip")
     TotalLeveredBeta = 3.44
  ...
  elseif(Industry == "Tobacco")
     TotalLeveredBeta = 9.37
  ...
  elseif(Industry == "Utility (Water)")
     TotalLeveredBeta = 3.33
  else
